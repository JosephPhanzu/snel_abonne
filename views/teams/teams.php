...
?>
    <div class="">
        <div class="mb-8">
            ...
            <p class="text-gray-400 mt-2">Gérez vos employés et leurs rôles</p>
        </div>
                    ...
                    contenuP += `
                        <tr class="hover:bg-black/20">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                ...
                                <button id="peut_vendre" data-value="${donne.peut_vendre}" data-code="${donne.code}" class="etat-connecter text-blue-200 hover:text-blue-300 mr-4" title="${donne.peut_vendre ? 'Interdire de vendre' : 'Autoriser à vendre'}"><i class="${donne.peut_vendre ? 'fa-solid fa-ban' : 'fa-solid fa-circle-check'} text-xl"></i></button>

                                <button class="text-red-600 hover:text-red-900" id="supprimer" title="Supprimer ${donne.nom}" data-code="${donne.code}"><i class="fa-solid fa-trash text-xl"></i></button>
                            </td>
                        </tr>
                    `;
                    i++;
