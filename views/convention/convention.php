...
?>
    <div class="">
        <div class="mb-8">
            ...
            <p class="text-gray-400 mt-2">Gérez vos Conventions</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div class="bg-black/40 backdrop-blur-sm border-blue-500/30 rounded-lg shadow-sm p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-blue-200">Total Conventions</p>
                        <p class="text-2xl font-bold text-blue-100" id="nbr_convention">00</p>
                    </div>
            ...
            <div class="bg-black/40 backdrop-blur-sm border-blue-500/30 rounded-lg shadow-sm p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-blue-200">Conventions Actives</p>
                        <p class="text-2xl font-bold text-blue-100" id="nbr_active">00</p>
                    </div>
        ...
        <div class="bg-black/40 border-blue-500/30 rounded-lg shadow-sm">
            <div class="p-6 border-b">
                <div class="flex justify-between items-center">
                    <h3 class="text-lg font-semibold text-blue-200">Liste des conventions</h3>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content bg-black/80 backdrop-blur-sm border-blue-500/30 rounded border border-primary">
                        <div class="modal-header">
                            <p class="modal-title text-blue-200">Ajout Convention</p>
                            ...
                            <form id="add-conv">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="description" class="bg-black/40 text-blue-100 border-blue-500/30 w-full px-3 py-2 border border-blue-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    </div>
                ...
                <table class="w-full">
                    <thead class="bg-black/30 backdrop-blur-sm border-blue-500/30">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-blue-100 uppercase">Description</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            const getbi = async (pageP) => {
                ...
                const res = await axios.get('/get_convention', {params : {limitP : limitP, page : pageP, code_pharmacie : code_pharma}})
                ...
                if (res.data.status == 'success') {
                    ...
                    if (Array.isArray(res.data.data)){
                        ...
                        $('#nbr_convention').text(donnees.length);
                        // $('#nbr-caissier').text(nbr_caisser);
                        // $('#nbr_active').text(nbr_pharmacien);
                ...
                donnees.forEach(donne => {
                    contenuP += `
                        <tr class="hover:bg-black/20">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-200">${donne.description}</td>
                            
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button class="text-red-600 hover:text-red-900 mx-1" id="supprimer" title="Supprimer ${donne.nom}" data-code="${donne.code}"><i class="fa-solid fa-trash text-xl"></i></button>

                                <button onclick="window.location.href='/facture_conv?ph=${code_pharma}&c=${donne.code}'" class="text-green-600 hover:text-green-900 mx-1" id="facture" title="Facture ${donne.nom}" data-code="${donne.code}">
            ...
            $(document).on('submit', '#add-conv', async function(e){
                e.preventDefault();
                const formData = new FormData(this);
                $('#info').removeClass('d-none');
                const res = await axios.post('/add_convention', formData)
                console.log(res.data.message);
                if (res.data.status === "success") {
