...
$routesGetMethode = [
    ...
    '/medecins'=> __DIR__ . '/views/medecin/medecin.php',
    '/rendez-vous' => __DIR__ . '/views/rdv/rdv.php',
    '/hospitalisations' => __DIR__ . '/views/hospitalisation/hospitalisation.php',
    '/facturation' => __DIR__ . '/views/facturation/facturation.php',
    '/parametres' => __DIR__ . '/views/parametres/parametres.php',
    '/patients' => __DIR__ . '/views/patients/patients.php',
    ...
    '/get_employe' => __DIR__ . '/scripts/employe/get_employe.php',
    '/get_employeurs' => __DIR__ . '/scripts/employeur/get_employeur.php',
...
$routesPostMethod = [
    ...
    '/add_employeur' => __DIR__ . '/scripts/employeur/add_employeur.php',
    ...
    '/ajout_panier'=> __DIR__ . '/scripts/panier/add_panier.php',
